...
#define BTN_DEBOUNCE_CYCLES 40  // Cycles of TIM2 to check button again for debounce purposes
#define BTN_REPEAT_PERIOD_MS 250 // When holding a button, new presses are registered every <this> ms
